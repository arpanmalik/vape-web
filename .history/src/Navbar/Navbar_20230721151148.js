          ...
          <div className="container">
            <div className="row d-flex align-items-center">
              <div className="col-md-6 col-lg-6">
                <div className="w-login d-flex">
                <a class="register" href="https://demo.bestprestashoptheme.com/vaping/en/login?create_account=1" rel="nofollow" title="Register Account"><i class="fa-solid fa-user"></i><span>Register</span></a>
                </div>
              </div>
            </div>
          </div>
