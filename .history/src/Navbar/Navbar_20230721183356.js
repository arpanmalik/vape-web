              ...
              <div className="three-sec-cont">
                ...
                <div className="right-cont">
                  ...
                  <div className="mini-cart">
                    <i className="fa-regular fa-heart" onClick={() => handleToggleOpen()}></i>
                    <Link to='/cart'>
                    <i className="fa-solid fa-cart-shopping"></i>
                    </Link>

                    <motion.div
        initial={{ height: 0, opacity: 0 }} // Initial state (closed)
        animate={{ height: isOpen ? 'auto' : 0, opacity: isOpen ? 1 : 0 }} // Animation state (open or closed)
        transition={{ duration: 0.3 }} // Animation duration
        style={{ overflow: 'hidden' }} // Hide overflowing content when closed
      >
        <div>
          {/* Content inside the element that will be opened */}
          <p>This content opens and closes with the button click.</p>
        </div>
      </motion.div>
                  </div>
                </div>
