      ...
      <div className="HomePage">
        <div className="Container">
          ...
          <div className="footer">
            <div className="upper-delivery-cont">
            <img src='https://demo.bestprestashoptheme.com/vaping/img/cms/icon-oto.png' alt='' />
            <p>FREE DELIVERY ON YOUR FIRST ORDER - ONLY $99</p>
