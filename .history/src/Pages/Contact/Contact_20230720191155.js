    ...
    <div className="contact-us">
      ...
      <div className="container-width">
        ...
        <div className="row">
          ...
          <label>Name</label>
          <br />
          <input type="text" name="Name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Name"></input>
          </div>
        </div>
