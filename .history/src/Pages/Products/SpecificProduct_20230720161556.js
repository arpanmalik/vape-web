            ...
            <div className="images-container thumb-bottom">
                <div className="product-cover">
                        <span className="w-100" style={{
                            ...
                            <img src='https://demo.bestprestashoptheme.com/vaping/49-large_default/mug-the-adventure-begins.jpg' alt='' className="js-qv-product-cover img-fluid image-zoom " 
style={{
