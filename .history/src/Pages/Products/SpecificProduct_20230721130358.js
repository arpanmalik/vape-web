            ...
            <div className="block_content">
              ...
              <div className="product-actions">
                <div className="product-add-to-cart">
                  ...
                  <div className="wishlist_bottom pt-60 pb-40">
                    <a
                      class="addToWishlist"
                      href="#"
                      data-rel="7"
                      onclick="WishlistCart('wishlist_block_list', 'add', '7', false, 1, '', 'Diamond Halo Stud Dolor', 'https://demo.bestprestashoptheme.com/vaping/en/accessories/7-mug-the-adventure-begins.html', 'https://demo.bestprestashoptheme.com/vaping/49-cart_default/mug-the-adventure-begins.jpg');
        return false;"
                    >
