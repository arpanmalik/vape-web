...
const About = () => {
  return (
    <div style={{}}>
      ...
      <div className="left">
        <img src="https://demo.bestprestashoptheme.com/vaping/modules/novnivoslider/images/f8fb50bd9c66846c67011be1c31d8cd558ed4fdc_slide2-1.jpg" alt="" />
      </div>
      <div className="right">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras tempus
          ...
          fames ac turpis egestas. Nulla ultricies diam et felis ornare, sit
          amet posuere eros blandit. Praesent nunc urna, pharetra non mauris
          consectetur, aliquam vestibulum nisi. Mauris tellus lectus, ultricies
          non quam .{" "}
        </p>
      </div>
    </div>
